...
#pragma warning disable 0414
        ...
        [HideInInspector]
        [SerializeField]
        private readonly bool ShowLayerWeightsInspector = true;

        [HideInInspector]
        [SerializeField]
        private readonly bool ShowParameterInspector = true;

#pragma warning restore 0414

        [HideInInspector]
        [SerializeField]
        private readonly List<SynchronizedParameter> m_SynchronizeParameters = new List<SynchronizedParameter>();

        [HideInInspector]
        [SerializeField]
        private readonly List<SynchronizedLayer> m_SynchronizeLayers = new List<SynchronizedLayer>();

        private Vector3 m_ReceiverPosition;
        private readonly float m_LastDeserializeTime;
        ...
        /// </summary>
        private readonly List<string> m_raisedDiscreteTriggersCache = new List<string>();
        ...
        private void Update()
        {
            if (m_Animator.applyRootMotion && m_PhotonView.IsMine == false && PhotonNetwork.IsConnected == true)
            {
