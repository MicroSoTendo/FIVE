...
namespace FIVE.UI.InGameDisplay
{
    ...
    public class ItemDialogViewModel : ViewModel
    {
        ...
        private void OnItemDialogRequested(object sender, ItemDialogRequestedEventArgs e)
        {
            ...
            MainThreadDispatcher.ScheduleCoroutine(ProcedureDisplayText.Routine(ItemNameInputField.textComponent,
                Callback));
        }

        private void Callback()
        {
            MainThreadDispatcher.ScheduleCoroutine(ProcedureDisplayText.Routine(DescriptionInputField.textComponent,
                null));
        }
